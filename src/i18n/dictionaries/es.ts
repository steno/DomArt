...
export const es: Dictionary = {
  ...
  home: {
    ...
    configureYours: "Configura la tuya",
  ...
  roomStrip: {
    ...
    living: "Sala",
    bathroom: "Baño",
    prev: "Habitaciones anteriores",
    next: "Habitaciones siguientes",
    alt: "Instalación Serie Fachada · {label}",
  },
  shop: {
    series: "Serie Fachada",
    title: "Tienda",
  ...
  howItsMade: {
    ...
    baseMaterialBody:
      "Tablas de pino natural claro (o madera blanda similar)—sin barnizar o con aceite ligero para que la veta se mantenga visible.",
    signature: "Elementos distintivos",
    signatureBody:
  ...
  gallery: [
    ...
    {
      id: "casa-alegre-mix",
      title: "Mezcla Casa Alegre",
      caption: "Bloques de color caribeño con juego.",
    },
    {
      id: "coral-living",
      title: "Sala Coral",
      caption: "Laterales verdes desgastados, marco coral.",
    },
  ],
  contact: {
    eyebrow: "Contacto",
    ...
    tradeThanks:
      "WhatsApp se abrió con tu consulta. Envía el mensaje y responderemos en dos días hábiles.",
    name: "Nombre",
    company: "Empresa",
    email: "Correo",
    message: "Mensaje",
  ...
  review: {
    ...
    notesPlaceholder:
      "Notas de instalación, plazos preferidos, solicitudes especiales…",
    inquireWhatsApp: "Consultar por WhatsApp",
    openingWhatsApp: "Abriendo WhatsApp…",
    opensNote:
      "Abre WhatsApp a {phone} con tu configuración. Confirmaremos los detalles allí.",
  },
  confirmation: {
    eyebrow: "Consulta abierta en WhatsApp",
    thankYou: "Gracias",
    body: "Tu configuración se abrió en WhatsApp. Envía el mensaje para consultar, y te responderemos con disponibilidad, instrucciones de pago y tu ventana de producción de {weeks}.",
    inquiry: "Consulta",
    design: "Diseño",
    estimate: "Estimado",
    whatsappMissed: "Si WhatsApp no se abrió, escríbenos al",
    questions: "¿Preguntas?",
  ...
  configurator: {
    ...
    lattice: "Franja de celosía",
    latticeHint: "Celosía blanca delgada · +$90",
    zocalo: "Zócalo",
  ...
  products: {
    "living-room": {
      ...
      features: [
        ...
        "Marco pintado delgado en color de acento",
      ],
      specs: {
        materials:
        ...
        depth: 'Perfil total de 3.5"',
        diyOption:
          "Kit con lista de corte y guía de acabado, o paneles totalmente acabados",
      },
      cutList: [
        "Tablas horizontales de fachada (pino)",
        "Ensamble central de persianas con lamas",
        "Paneles verticales izquierdo y derecho",
        "Rieles y montantes del marco de acento",
        "Zócalo opcional",
        "Franja de celosía opcional",
        "Marco de nicho para TV opcional",
      ],
    },
    "bedroom-headboard": {
      name: "Pared cabecero",
      ...
      features: [
        ...
        "Paneles verticales laterales suaves",
        "Celosía opcional para detalle ligero",
      ],
      specs: {
        materials:
          "Tablas de pino natural claro, sin barnizar o con aceite ligero",
        finish:
          "Persianas, marco y molduras pintados en tu color de acento + blanco",
        modularWidths: '72", 96", 120", 144"',
        depth: 'Perfil total de 3"',
        diyOption:
          "Kit con lista de corte y guía de acabado, o paneles totalmente acabados",
      },
      cutList: [
        "Tablas horizontales de fachada (pino)",
        "Ensamble central de persianas",
        "Paneles verticales izquierdo y derecho",
        "Marco de acento",
        "Zócalo opcional",
        "Franja de celosía opcional",
    ...
    "dining-room": {
      name: "Pared de acento para comedor",
      shortName: "Comedor",
      ...
      features: [
        ...
        "Zócalo opcional para presencia firme",
        "Compatible con zócalos existentes",
      ],
      specs: {
        materials:
          "Tablas de pino natural claro, sin barnizar o con aceite ligero",
    ...
    bathroom: {
      ...
      cutList: [
        "Tablas horizontales de fachada (pino)",
        "Ensamble central de persianas / botiquín",
        "Paneles verticales izquierdo y derecho",
        "Marco de acento",
        "Zócalo opcional",
        "Franja de celosía opcional",
  ...
  colorways: {
    costa: {
      name: "Costa",
      description: "Turquesa inspirada en las aguas costeras del Caribe.",
    },
    sol: {
      name: "Sol",
      description: "Amarillo soleado que atrapa la luz cálida de la tarde.",
    },
    jungla: {
      name: "Jungla",
      description: "Verde menta tomado de la sombra del jardín tropical.",
    },
    coral: {
      name: "Coral",
      description: "Calidez coral de los atardeceres de Puerto Plata.",
    },
    "soft-pink": {
      name: "Rosa Suave",
      description: "Rosa suave para interiores serenos y luminosos.",
    },
    navy: {
      name: "Navy",
      description: "Azul navy profundo para una calma sofisticada de noche.",
    },
  },
  whatsapp: {
    greeting:
    ...
    estimate: "Estimado",
    closing: "Por favor confirmen disponibilidad y próximos pasos. ¡Gracias!",
  },
};
